...
public class TestBase {
	...
	public String getAdminUserID() {
		...
		} else if (appLibrary.baseUrl.contains("dev") || appLibrary.baseUrl.contains("qa")) {
			email = loadUserProperties().getProperty("ADMIN_USER_DEV");
		} else {
			email = loadUserProperties().getProperty("ADMIN_USER_PROD");
		}
		return email;
	}
	...
	public String getAdminPassword() {
		...
		if (appLibrary.baseUrl.contains("stage")) {
			...
			pass = loadUserProperties().getProperty("ADMIN_PASS_PROD");
		}
